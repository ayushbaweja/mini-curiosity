"""
A2C with Intrinsic Curiosity Module (ICM) for MountainCar-v0
"""
...
def train_a2c_with_icm(
    ...
    icm_eta=0.01,
    lambda_weight=0.1,
    save_path="models/icm/a2c_mountaincar_icm"
):
    """
    Train A2C with ICM on MountainCar-v0
    ...
    print(f"\n{'='*50}")
    print(f"Training A2C with ICM on MountainCar-v0")
    print(f"{'='*50}")
...
if __name__ == "__main__":
    ...
    test_model("a2c_mountaincar_icm_final", n_episodes=10, render=False, model_type='icm')